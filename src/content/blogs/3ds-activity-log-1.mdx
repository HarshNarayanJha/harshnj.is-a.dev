...
<YouTube
  id="https://youtu.be/HIF_BWJGWsg"
  title="The 3DS Is Walking Away From The Past - Activity Log"
/>
...
This was the part 1 of the blog series about 3DS Activity Log. The [next part](/blog/3ds-activity-log-2) will explain what is the save data format, how I managed to extract it and the streamlined process I figured out. I will share the progress on the main web app, and hopefully the 3ds homebrew application to export the playdata.
